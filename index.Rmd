...
v3 <- glmmTMB(V2 ~ Quantity + S*N.flowers + (1|Species), family = "gaussian", data = all)
summary(v3)
car::Anova(v3, type = 3)


v4 <- glmmTMB(V2 ~  Quantity + (1|Species), family = "gaussian", data = all)
summary(v4)
AIC(v1, v2, v3, v4)



interact_plot(v3, S, N.flowers)
